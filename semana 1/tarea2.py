...
def examenes(nota1: float ,nota2: float,nota3: float):
    ...
    resultado :float
    """
    resultado=(nota1/100)*10+(nota2/100)*10+(nota3/100)*20
...
print(f"Examenes (40%): {examenes(num1,num2,num3)}")
print(f"Proyetos (30%): {proyectos(num4,num5)}")
print(f"Tareas (20%): {tareas(num6)}")
print(f"Participacion (10%): {num7}")
